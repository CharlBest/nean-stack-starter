...
CREATE (user:User { id: nextId, uId: {uId}, email: {email}, username: {username}, passwordHash: {passwordHash}, dateCreated: timestamp(), isVerified: false, views: 0, bio: '', emailCode: {emailCode}, emailVerified: false })
